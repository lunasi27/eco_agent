...
set log_file      = ${run_dir}/run_fix_hold.log

echo "==== run_fix_hold ====" >! $log_file
...
#   "eco_fix_hold -strategy $fix_strategy -target_margin $target_margin; exit"

echo "Hold Violations After Fix: 3" >> $log_file
echo ""                              >> $log_file
